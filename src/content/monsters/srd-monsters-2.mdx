    ...
    actions:
      ...
      - name: Bite
        content: >-
          ...
          total cover against attacks and other effects outside the kraken, and it
          takes 42 (12d6) acid damage at the start of each of the kraken's turns.
      ...
      - name: Lightning Storm
        content: >-
          The kraken magically creates three bolts of lightning, each of which can
    ...
    legendaryactions:
      ...
      - name: Ink Cloud (Costs 3 Actions)
        content: >-
          ...
          throw, taking 16 (3d10) poison damage on a failed save, or half as much
          damage on a successful one. A strong current disperses the cloud, which
