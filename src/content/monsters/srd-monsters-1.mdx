...
monsters:
  ...
  - name: Deep Gnome (Svirfneblin)
    ...
    actions:
      ...
      - name: Poisoned Dart
        content: >-
          Ranged Weapon Attack: +4 to hit, range 30/120 ft., one creature. Hit: 4
          (1d4 + 2) piercing damage, and the target must succeed on a DC 12
    ...
    actions:
      - name: Scimitar
        content: |
          ...
          <Attack>Scimitar|+4|1d6+2|slashing</Attack>
      - name: Shortbow
        content: |
          Ranged Weapon Attack: +4 to hit, range 80/320 ft., one target. Hit: 5
          (1d6+2) piercing damage.

          <Attack>Shortbow|+4|1d6+2|piercing</Attack>
    reactions: null
    legendaryactions: null
    description: ''
    imgurl: >-
